...
if [[ $# -eq 1 ]]; then
    ...
    selected=$(find /home/admd/dev/super_resolution/ /home/admd/dev/indents /home/admd/dev/microscope_automation /home/admd/dev/16MnCrS5 /home/admd/dev/damage/ -mindepth 2 -maxdepth 2 -type d | fzf)
fi
